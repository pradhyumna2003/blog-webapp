...
<head>
    ...
    <script>
        ...
        function loginPage() {
            ...
            // Get the current page's hostname (e.g., www.example.com)
            var hostname = window.location.hostname;
            // Construct the full URL by combining the protocol, hostname, and the provided path
            var fullUrl = protocol + "//" + hostname + "login.php";
